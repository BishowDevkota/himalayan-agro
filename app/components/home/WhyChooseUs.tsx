...
export default function WhyChooseUs() {
  ...
  return (
    <section ref={sectionRef} className="relative bg-[#f8fafb] py-12 sm:py-16 lg:py-20 overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-100 h-100 rounded-full bg-cyan-50 opacity-35 -translate-y-1/2 -translate-x-1/3 pointer-events-none" />
      <div className="absolute bottom-0 right-0 w-87.5 h-87.5 rounded-full bg-green-50 opacity-30 translate-y-1/2 translate-x-1/3 pointer-events-none" />
          ...
          <div className="max-w-2xl mx-auto">
            <div className="space-y-4">
              {advantages.map((item, index) => (
                ...
                >
                  <div className="shrink-0 w-10 h-10 rounded-xl bg-[#059669]/8 flex items-center justify-center text-[#059669] group-hover:bg-[#059669] group-hover:text-white transition-all duration-300">
