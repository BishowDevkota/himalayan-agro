      ...
      {slides.map((slide, index) => (
        ...
        >
          ...
          <div className="relative z-[3] text-center text-white px-5">
            ...
            <button className={`${slide.btnClass} text-white px-9 py-4 font-bold uppercase tracking-wider text-xs hover:-translate-y-1 transition-transform duration-300 shadow-xl`}>
              {slide.btnText}
            </button>
          </div>
        </div>
