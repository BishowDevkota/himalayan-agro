...
className="h-14 sm:h-16 w-auto object-contain lg:hidden transform group-hover:scale-105 transition-transform"
...
className="hidden lg:inline-block h-18 sm:h-20 w-auto rounded-lg object-contain sm:object-cover transform group-hover:scale-105 transition-transform"
