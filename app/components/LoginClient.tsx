        ...
        >
          <div className="max-w-sm mx-auto">
            ...
            >
              ...
              <p className="mt-2 text-sm text-white/70 max-w-xs mx-auto">Sign in to manage your orders and check out faster.</p>
            </motion.div>
...
<p className="text-sm text-gray-400">
               ...
               <a href="/register/user" className="text-[#2da8da] font-semibold hover:text-[#1e8bb8] transition-colors duration-200 relative group">
                 Create one
