      ...
      <div className="max-w-7xl mx-auto pt-28 pb-16 px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div>
            ...
            <p className="mt-2 text-sm text-slate-500">Distributor store front</p>
          </div>
        </div>
        ...
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
          <section className="lg:col-span-2 bg-white border border-gray-100 rounded-2xl p-6 shadow-sm">
            ...
            <div className="mt-4 text-sm text-slate-600">{distributor.description || "No description provided."}</div>
          ...
          <aside className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm">
            ...
            <div className="mt-3 text-sm text-slate-600">{distributor.contactEmail}</div>
